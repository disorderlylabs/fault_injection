...
\affil{\textit{University of California, Santa Cruz} \vspace{0.5ex} \authorcr {\tt \{atran18, palvaro\}@ucsc.edu}\vspace{0.0ex}}
...
% only include acknowledgements for the camera-ready version
%\vspace{0.5cm}
%\centerline{\textbf{Acknowledgments}}
%We thank the team at Netflix and Lightbend for making us realize our work is very much relevant in production environments.
